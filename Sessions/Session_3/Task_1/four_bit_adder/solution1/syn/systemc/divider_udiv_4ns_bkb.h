...
// ==============================================================
#ifndef __divider_udiv_4ns_bkb__HH__
#define __divider_udiv_4ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(divider_udiv_4ns_bkb) {
    ...
    SC_CTOR(divider_udiv_4ns_bkb):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
