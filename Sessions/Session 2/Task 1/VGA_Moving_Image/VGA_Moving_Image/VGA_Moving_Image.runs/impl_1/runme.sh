...
HD_PWD='C:/Users/Ali/Desktop/Vivado/VGA_Moving_Image/VGA_Moving_Image.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Moving_Image.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_Moving_Image.tcl -notrace
